...
async function _testBibleReferences() {
    ...
    const result = await Promise.all(Object.entries(Readings)
        .map(([name, array]) => {
    ...
    async function retrieveFromBible(reading, langs, arrayName) {
        ...
        async function retrieveVerses(lang, ref) {
            ...
            const text = await Promise.all(refs.map(async (ref) => {
                const [chapterNumber, versesRange] = ref.replace(`${bookID}:`, '').split(':');
                if (!chapterNumber || !versesRange)
                    return `Failed to retrieve verses because either the chapterNumber or the versesRange could not be extracted from the reading reference. lang = ${lang}, bookID = ${bookID}, chapter = ${chapterNumber}, versesRange = ${versesRange}, ref = ${ref}, arrayName = ${arrayName}`;
                await Promise.all(versesRange
                    .split('/')
                    .map(async (range) => {
            ...
            return text.join('\n');
            function replaceEnd(range, chapter, lang) {
        ...
        async function retrieveVersesText(lang, bookID, chapterNumber, verses) {
            ...
            function getVersesRange(chapter, [Start, End]) {
                ...
                if (!first)
                    return `Failed to retrieve the first verse of the range: first verse = ${Start}, last verse = ${End}, lang = ${lang}, bookID = ${bookID}, chapter = ${chapterNumber}, , arrayName = ${arrayName}`;
                let last = chapter.find(verse => verse?.[0] === End);
                if (!last)
                    return `Failed to retrieve last verse: last verse = ${End}, lang = ${lang}, first verse = ${Start}, bookID = ${bookID}, chapter = ${chapterNumber}, arrayName = ${arrayName}`;
            }
        }
    }
}
...
//# sourceMappingURL=data:application/json;base64,